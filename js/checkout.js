...
const firstnameBilling = document.getElementById("id_first_name_billing");
const lastnameBilling = document.getElementById("id_last_name_billing");
const addressBilling = document.getElementById(
  "id_shipping_address_line1_billing"
);
const cityBiling = document.getElementById("id_shipping_address_line4_billing");
const stateBilling = document.getElementById("id_shipping_state_billing");
const zipBilling = document.getElementById("id_shipping_postcode_billing");
const countryBilling = document.getElementById("id_shipping_country_billing");
